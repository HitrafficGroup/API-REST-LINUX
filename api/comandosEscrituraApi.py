...
def hitrafficSetTimeControlador(ip, time_zone,data):
    ...
    try:
        output = run(args=['wine',comandoBaseWrite,str(ip),'--sincronizar_hora_fecha'],capture_output=True, timeout=20).stdout
    except:
...
def hitrafficSetGruposControlador(ip,g1,g2,g3,g4,data):
    ...
    try:
        output = run(args=['wine',comandoBaseWrite,str(ip),'--escribir_grupos',g1,g2,g3,g4],capture_output=True, timeout=20).stdout
...
def hitrafficSetFasesControlador(ip,f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16): 
    ...
    try:
        output = run(args=['wine',comandoBaseWrite,str(ip),'--escribir_fases',f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15,f16],capture_output=True, timeout=20).stdout
...
def hitrafficSetPlanesControlador(ip,num_plan,fase1,tiempo1,fase2,tiempo2,fase3,tiempo3,fase4,tiempo4,fase5,tiempo5,fase6,tiempo6,fase7,tiempo7,fase8,tiempo8,fase9,tiempo9,fase10,tiempo10,fase11,tiempo11,fase12,tiempo12):
    ...
    try:
        ...
        output = run(args=['wine',comandoBaseWrite,str(ip),'--escribir_fases',num_plan,fase1,tiempo1,fase2,tiempo2,fase3,tiempo3,fase4,tiempo4,fase5,tiempo5,fase6,tiempo6,fase7,tiempo7,fase8,tiempo8,fase9,tiempo9,fase10,tiempo10,fase11,tiempo11,fase12,tiempo12],capture_output=True, timeout=20).stdout
...
def hitrafficSetOtrosParamControlador(ip,time_destello_on,time_red_on,time_destello_green_p,time_destello_green_v,time_yellow_v,time_all_red,time_min_green,sincro_value):
    ...
    try:
        ...
        output = run(args=['wine',comandoBaseWrite,str(ip),'--escribir_otros_parametros',time_destello_on,time_red_on,time_destello_green_p,time_destello_green_v,time_yellow_v,time_all_red,time_min_green,sincro_value],capture_output=True, timeout=20).stdout
...
def hitrafficSetConflictoVerdesControlador(ip,fila1,fila2,fila3,check1,check2,check3):
    ...
    try:
        ...
        output = run(args=['wine',comandoBaseWrite,str(ip),'--escribir_conflicto_verdes',fila1,fila2,fila3,check1,check2,check3],capture_output=True, timeout=20).stdout
...
def hitrafficSetEntradasControlador(ip,mac,box1,fase1,tiempo1,box2,fase2,tiempo2,box3,fase3,tiempo3,box4,fase4,tiempo4):
    ...
    try:
        ...
        output = run(args=['wine',comandoBaseWrite,str(ip),'--escribir_entradas',box1,fase1,tiempo1,box2,fase2,tiempo2,box3,fase3,tiempo3,box4,fase4,tiempo4],capture_output=True, timeout=20).stdout
    except:
...
def hitrafficSetRegistrosControlador(ip,observacion='undefined'):
    ...
    try:
        output = run(args=['wine',comandoBaseWrite,str(ip),'--borrar_registros'],capture_output=True, timeout=20).stdout
...
def hitrafficSetBorrarErrorControlador(ip,observacion='undefined'):
    ...
    try:
        ...
        output = run(args=['wine',comandoBaseWrite,str(ip),'--eliminar_error'],capture_output=True, timeout=20).stdout
    except:
...
def hitrafficSetCambiarIpControlador(ip, nueva_ip,mac):
    ...
    try:
        ...
        output = run(args=['wine',comandoBaseWrite,str(ip),'--cambiar_ip',str(nueva_ip), str(mac)],capture_output=True, timeout=20).stdout
    except:
